...
function JobListing({
  ...
  return (
    <div className="grid grid-rows-[2fr,.5fr] border-[1px]">
      <div className="grid grid-cols-[2fr,.5fr]">
        <div className="flex items-center p-8 gap-4">
          <div className="h-20 p-4 border-[1px] rounded-md">
            <img
              src={companyImage}
              alt="apple icon"
        ...
        <div className="border-l-[1px] px-8 flex justify-center items-center">
          <button className="bg-blue-color py-2 px-4 rounded-md text-white flex justify-center items-center">
            Apply
          </button>
        </div>
      </div>
      <div className="border-t-[1px] text-secondary-text-color">
